...
$(document).ready(function () {
	...
	$('.news__item').each(function() {
		$(this).on('click', function() {
			$('.modal-title').text($(this).find('.news__item-top').text());
			$('.modal-text').text($(this).find('.news__item-desc').text());
			$('.modal-date').text($(this).find('.news__item-date').text());
			$('.modal-img img').attr('src', $(this).find('.news__content img').attr('data-src'));

			$('body').css('width', lw);
			$('body, html').addClass('off-scroll');
		...
		$('.overlay').on('click', function(event) {
			if (event.target !== $('.modal') && $('.modal').has(event.target).length === 0) {
				$('body, html').removeClass('off-scroll');
				$('.overlay').removeClass('active');
				$('.modal-news').removeClass('active');
			}
		});
	...
	$(".prod__item").click(function() {
		$(".prod__tab-container").removeClass("active");
		var ht = $(this).find('.prod__item-images').html();
		var desc = $(this).find('.prod__item-desc').html();
		$(this).closest(".prod__items").find(".prod__tab-container .prod__tab-left").html(ht);
		$(this).closest(".prod__items").find(".prod__tab-container .prod__tab-right .prod__text").html(desc);

		if ($(this).find(".prod__item-button").hasClass('active')) {
			$(this).find(".prod__item-button").removeClass("active");
			$(this).closest(".prod__items").find(".prod__tab-container").removeClass("active");
		} else {
			$(".prod__item-button").removeClass("active");
			$(this).find(".prod__item-button").addClass("active")
			$(this).closest(".prod__items").find(".prod__tab-container").addClass("active");
		}
	});
	...
	$(".more-button").click(function() {
		if ($(this).hasClass('active')) {
			...
			$(this).closest(".more-content").find(".more-text").removeClass("active")
		} else {
			$(this).closest(".more-content").find(".more-text").removeClass("active")
			$(this).addClass("active")
			$(this).closest(".more-content").find(".more-text").addClass("active")
		}
	});
